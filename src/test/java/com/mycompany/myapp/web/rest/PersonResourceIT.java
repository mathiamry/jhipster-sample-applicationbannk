...
class PersonResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "5@?B#9k.i\\YW";
    private static final String UPDATED_EMAIL = "J\"S@b.g)zH";
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
        return person;
    }
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void partialUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);

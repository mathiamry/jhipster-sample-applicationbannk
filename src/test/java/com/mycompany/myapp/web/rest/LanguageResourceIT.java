...
class LanguageResourceIT {
    ...
    public static Language createEntity(EntityManager em) {
        Language language = new Language().name(DEFAULT_NAME).key(DEFAULT_KEY);
        return language;
    }
    ...
    public static Language createUpdatedEntity(EntityManager em) {
        Language language = new Language().name(UPDATED_NAME).key(UPDATED_KEY);
        return language;
    }
    ...
    void createLanguage() throws Exception {
        ...
        assertThat(testLanguage.getKey()).isEqualTo(DEFAULT_KEY);
    }
    ...
    void putNewLanguage() throws Exception {
        ...
        updatedLanguage.name(UPDATED_NAME).key(UPDATED_KEY);
        ...
        assertThat(testLanguage.getKey()).isEqualTo(UPDATED_KEY);
    }
    ...
    void fullUpdateLanguageWithPatch() throws Exception {
        ...
        partialUpdatedLanguage.name(UPDATED_NAME).key(UPDATED_KEY);
